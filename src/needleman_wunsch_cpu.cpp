...
struct ProgramOptions {
    ...
    needleman_wunsch::ScoringScheme scoring;
    int repetitions = 5;
...
void write_results_csv(const std::string& output_path,
    ...
    output_file << "pair_id,sequence_length_a,sequence_length_b,alignment_score\n";
...
int main(int argc, char** argv) {
    try {
        ...
        std::cout << "Needleman-Wunsch CPU alignment completed.\n";
        ...
        std::cout << "ALGORITHM=needleman_wunsch_cpu\n";
