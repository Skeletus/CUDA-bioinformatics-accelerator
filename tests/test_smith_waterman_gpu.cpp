...
#ifdef _WIN32
    return ".\\smith_waterman_gpu.exe";
#else
    return "./smith_waterman_gpu";
#endif
}
...
int main() {
    try {
        ...
        all_tests_passed = run_gpu_validation_case("local_match_gpu", "GGACGTCC TTACGTAA\n") && all_tests_passed;
        all_tests_passed = run_gpu_validation_case("no_useful_match_gpu", "AAAA TTTT\n") && all_tests_passed;
        all_tests_passed = run_gpu_validation_case("partial_local_match_gpu", "GATTACA CCCTACA\n") && all_tests_passed;
